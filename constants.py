...
LOCAL_MODEL_PATH = f"{ROOT_DIRECTORY}/llm_model/codellama-7b.Q3_K_M.gguf"
...
#EMBEDDING_MODEL_NAME = "sentence-transformers/all-mpnet-base-v2" #uses 0.5GB
EMBEDDING_MODEL_NAME = "/root/ask-ncc/embedding_model/all-mpnet-base-v2"    ## using local downloaded model
...
#MODEL_BASENAME = "codellama-7b-python.Q3_K_L.gguf"

MODEL_ID = "TheBloke/CodeLlama-7B-GGUF"
MODEL_BASENAME = "codellama-7b.Q3_K_M.gguf"
